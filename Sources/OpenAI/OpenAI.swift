...
final public class OpenAI: OpenAIProtocol {
    ...
    public func getFiles(method: String, completion: @escaping (Result<AllFilesResult, Error>) -> Void) {
        performRequest(request: JSONRequest<AllFilesResult>(body: nil, url: buildURL(path: .files), method: "GET"), completion: completion)
    }
